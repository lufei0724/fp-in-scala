...
class ListsSuite extends munit.FunSuite:
  ...
  test("sum an empty list (10pts)") {
    assertEquals(sum(List()), 0)
  }

  test("sum of repeated numbers (10pts)") {
    assertEquals(sum(List(1, 1, 1, 1)), 4)
  }

  test("sum of a few negative numbers (10pts)") {
    assertEquals(sum(List(-1, -2, -3, -4)), -10)
  }

  test("sum of a few negative and positive numbers (10pts)") {
    assertEquals(sum(List(-1, -2, -3, -4, 5, 2)), -3)
  }
  ...
  test("max of negative numbers (10pts)") {
    assertEquals(max(List(-3, -7, -1)), -1)
  }

  test("max of repteaded numbers (10pts)") {
    assertEquals(max(List(-3, -3, -3, -3, -4)), -3)
  }

  test("max of zero (10pts)") {
    assertEquals(max(List(0)), 0)
  }
